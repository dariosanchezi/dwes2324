...
session_start();
$captcha = "";
$totalCharacteres = 5; // Longitud máxima del captcha
$possiblesLetras = "123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
$captchaFont = "CartoonBlocks.ttf";
$captchaFontSize = 30; // Tamaño de la fuente
$caracter = 0;
while ($caracter < $totalCharacteres) {
 $captcha .= substr( $possiblesLetras, rand(0,strlen($possiblesLetras)),1 ); // Se extrae 1 letra de $possiblesLetras de la posición aleatoria según el tamaño de la variable.
 $caracter++;
}
