<?php
require_once __DIR__ . '/../excepciones/QueryException.class.php';
require_once __DIR__ . '/../excepciones/NotFoundException.class.php';
require_once __DIR__ . '/../entity/Imagen.class.php';
require_once __DIR__ . '/../entity/categoria.class.php';
require_once __DIR__ . '/../entity/IEntity.class.php';
