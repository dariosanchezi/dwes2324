          ...
          <div class="block1">
            ...
            <div class="col-xs-12 col-sm-3">
              ...
              <div class="new new1">
                ...
                <p>10 April</p><i class="fa fa-clock-o sr-icons"></i> 8:00 AM<hr />
              </div>
              <div class="new">
                <hr />
                <a href="">Consequuntur</a>
                <h5>By <span>Omnis</span></h5>
                <p>12 May</p><i class="fa fa-clock-o sr-icons"></i> 4:00 PM<hr />
              </div>
            </div>
          </div>
        </div>
