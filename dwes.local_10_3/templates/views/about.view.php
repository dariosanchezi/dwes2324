    ...
    <div id="about">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <p class="text-muted">
              <strong>PHOTOSHOP</strong> <span class="pull-right">80%</span>
            </p>
            <div class="progress">
            ...
            <p class="text-muted">
              <strong>SHOOTING PHOTO</strong><span class="pull-right">95%</span>
            </p>
            <div class="progress">
            ...
            <p class="text-muted">
              <strong>FORMATION</strong><span class="pull-right">90%</span>
            </p>
            <div class="progress">
